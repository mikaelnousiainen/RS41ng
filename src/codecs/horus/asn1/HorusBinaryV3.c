/*
 * Horus Binary v3 - ASN.1 Codec
 *
 * Generated with asn1scc (https://github.com/esa/asn1scc) by ESA
 * Written by @xssfox with Project Horus
 * 
...
const horusVia Via_sondehub = 0;
const horusVia Via_nohub = 1;
const horusVia Via_unknown1 = 2;
const horusVia Via_unknown2 = 3;
const horusVia Via_unknown3 = 4;
const horusVia Via_unknown4 = 5;
const horusVia Via_unknown5 = 6;
const horusVia Via_unknown6 = 7;
...
flag horusTelemetry_fieldCount_IsConstraintValid(const horusTelemetry_fieldCount* pVal, int* pErrCode)
{
    flag ret = TRUE;
    ret = ((*(pVal)) <= 127);
    *pErrCode = ret ? 0 :  ERR_TELEMETRY_FIELDCOUNT;
                                                        ...
                                                        if (ret) {
                                                            ...
                                                            if (ret) {
                                                                ...
                                                                if (ret) {
                                                                    ...
                                                                    if (ret) {
                                                                        ret = horusTelemetry_fieldCount_IsConstraintValid((&(pVal->fieldCount)), pErrCode);
                                                                    }   /*COVERAGE_IGNORE*/
                                                                }   /*COVERAGE_IGNORE*/
                                                            }   /*COVERAGE_IGNORE*/
                                                        }   /*COVERAGE_IGNORE*/
...
void horusTelemetry_Initialize(horusTelemetry* pVal)
{
	...
	pVal->extensionMarkerForASN1CC = 0;
	/*set payloadCallsign */
	...
	/*set fieldCount */
	horusTelemetry_fieldCount_Initialize((&(pVal->fieldCount)));
}
	                                                                                                        ...
	                                                                                                        if (ret) {
	                                                                                                            ...
	                                                                                                            if (ret) {
	                                                                                                                ...
	                                                                                                                if (ret) {
	                                                                                                                    ...
	                                                                                                                    if (ret) {
																															if (pVal->exist.fieldCount) {
																																/*Encode fieldCount */
																																BitStream_EncodeConstraintPosWholeNumber(pBitStrm, pVal->fieldCount, 0, 127);
																															}
	                                                                                                                    }   /*COVERAGE_IGNORE*/
	                                                                                                                }   /*COVERAGE_IGNORE*/
	                                                                                                            }   /*COVERAGE_IGNORE*/
	                                                                                                    ...
	                                                                                                    if (ret) {
	                                                                                                        ...
	                                                                                                        if (ret) {
	                                                                                                            ...
	                                                                                                            if (ret) {
	                                                                                                                ...
	                                                                                                                if (ret) {
	                                                                                                                    /*Decode fieldCount */
	                                                                                                                    ret = BitStream_DecodeConstraintPosWholeNumber(pBitStrm, (&(pVal->fieldCount)), 0, 127);
	                                                                                                                    *pErrCode = ret ? 0 : ERR_UPER_DECODE_TELEMETRY_FIELDCOUNT;
	                                                                                                                }   /*COVERAGE_IGNORE*/
	                                                                                                            }   /*COVERAGE_IGNORE*/
	                                                                                                        }   /*COVERAGE_IGNORE*/
	                                                                                                    }   /*COVERAGE_IGNORE*/
...
flag horusVia_Encode(const horusVia* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	ret = bCheckConstraints ? horusVia_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret && *pErrCode == 0) {
...
flag horusVia_Decode(horusVia* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = ret ? 0 : ERR_UPER_DECODE_VIA;                               

	return ret  && horusVia_IsConstraintValid(pVal, pErrCode);
}
...
flag horusExtensions_IsConstraintValid(const horusExtensions* pVal, int* pErrCode)
{
    flag ret = TRUE;
    if (pVal->exist.via) {
    	ret = horusVia_IsConstraintValid((&(pVal->via)), pErrCode);
    }
...
flag horusExtensions_Encode(const horusExtensions* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	ret = bCheckConstraints ? horusExtensions_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret && *pErrCode == 0) {
	    BitStream_AppendBit(pBitStrm,pVal->exist.via);
	    if (ret) {
	        /*Encode via */
	        if (pVal->exist.via) {
	        	ret = horusVia_Encode((&(pVal->via)), pBitStrm, pErrCode, FALSE);
	        }
	    }   /*COVERAGE_IGNORE*/
    } /*COVERAGE_IGNORE*/
...
flag horusExtensions_Decode(horusExtensions* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	ret = BitStream_ReadBit(pBitStrm, &presenceBit);
	pVal->exist.via = presenceBit == 0 ? 0 : 1;
	*pErrCode = ret ? 0 : ERR_UPER_DECODE_EXTENSIONS;
	if (ret) {
	    /*Decode via */
	    if (pVal->exist.via) {
	    	ret = horusVia_Decode((&(pVal->via)), pBitStrm, pErrCode);
	    }
	}   /*COVERAGE_IGNORE*/

	return ret  && horusExtensions_IsConstraintValid(pVal, pErrCode);
}
